const styles = {
  ...
  heroHeadText:
    'font-black text-customGreen lg:text-[110px] sm:text-[70px] xs:text-[60px] text-[60px] lg:leading-[90px] mt-2',
  heroSubText:
  ...
  sectionHeadTextLight:
    'text-timberWolf font-black md:text-[50px] sm:text-[42px] xs:text-[30px] text-[25px] font-poppins',
  sectionSubText:
